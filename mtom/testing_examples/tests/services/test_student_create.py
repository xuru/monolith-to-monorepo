...
from mtom.testing_examples.services import student_create
from mtom.testing_examples.tests.factories import SchoolCourseFactory, SchoolFactory
from mtom.utils.tests import faker


class StudentCreateTests(TestCase):
    @patch("mtom.testing_examples.services.students.school_list_school_courses")
    @patch("mtom.testing_examples.services.students.roster_create")
