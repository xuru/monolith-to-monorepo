...
from mtom.testing_examples.models import Roster
from mtom.testing_examples.services import ROSTER_CREATE_DIFFERENT_SCHOOLS, roster_create
from mtom.testing_examples.tests.factories import SchoolCourseFactory, StudentFactory
...
class RosterCreateTests(TestCase):
    ...
    @patch("mtom.testing_examples.services.rosters.roster_validate_period")
